...
echo"<form  action ='supdate.php'  class='formoid-flat-green' style='font-size:16px;font-family:'Lato', sans-serif;max-width:550px;min-width:150px' method='post'><div class='title'><h2>Shop keeper update</h2></div>";
