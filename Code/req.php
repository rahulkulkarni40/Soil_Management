...
echo"</style></head>";
		...
		echo"<form action='resps2.php' class='formoid-flat-green' style='background-color:#FFFFFF;font-size:14px;font-family:'Lato', sans-serif;color:#666666;max-width:480px;min-width:150px' method='post'>";
		...
		echo"<div class='element-textarea' ><label class='title'>Response</label><textarea class='medium' id='ans' name='ans' cols='20' rows='5' value='".$row['response']."'></textarea></div>";
