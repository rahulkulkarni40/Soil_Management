...
echo"<form action='fupdate.php'class='formoid-metro-cyan' style='background-color:;font-size:16px;font-family:'Open Sans','Helvetica Neue','Helvetica',Arial,Verdana,sans-serif;max-width:550px;min-width:150px' method='post'><div class='title'><h2>Farmer registration</h2></div>";
...
echo"<div class='element-number' ><label class='title'>Conatct</label><input class='large' type='text' min='0' max='10000000000' name='ph' readonly value='".$row['contact']."'></ required/></div>";
